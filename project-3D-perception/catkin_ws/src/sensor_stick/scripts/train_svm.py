...
#TODO: need to change the filename number
...
#TODO: change the finename according to training sets.
model_num = 1
output_name = 'model'+str(model_num)+ '.sav'
#output_name = 'model.sav'
pickle.dump(model, open(output_name, 'wb'))
