...
# Exercise-3 TODOs: 
    ...
    detected_objects_pub.publish(detected_objects_labels)
if __name__ == '__main__':

    # TODO: ROS node initialization
    rospy.init_node('clustering', anonymous=True)
    # TODO: Create Subscribers /sensor_stick/point_cloud
    ...
    model = pickle.load(open('model_test.sav', 'rb'))
